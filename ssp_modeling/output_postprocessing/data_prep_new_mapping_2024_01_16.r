...
mapping <- read.csv("data/mapping_corrected_uganda.csv")

#add edgar 
edgar <- read.csv("data/CSC-GHG_emissions-April2024_to_calibrate.csv")
...
#write file 
dir.out <- paste0("Tableau/data/")
file.name <- "emissions_BaU_250424.csv"
